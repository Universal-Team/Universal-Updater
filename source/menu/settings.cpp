...
static const std::vector<std::string> languages = { "Čeština", "Dansk", "Deutsch", "English", "Español", "Français", "Italiano", "Lietuvių", "Magyar", "Nederlands", "Norsk", "Polski", "Português (Portugal)", "Português (Brasil)", "Română", "Türkçe", "Русский", "Украïнська", "中文 (简体)", "中文 (繁體)", "日本語", "琉球諸語", "한국어" };
static const std::string langsTemp[] = { "cs", "da", "de", "en", "es", "fr", "it", "lt", "hu", "nl", "no", "pl", "pt", "pt-BR", "ro", "tr", "ru", "uk", "zh-CN", "zh-TW", "jp", "ry", "ko" };
